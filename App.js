...
async function showMovies(pageNumber = 1, sort_by = "desc") {
  ...
  const options = {
    ...
    headers: {
      ...
      Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJkMTNlOTMyM2QzZjQ4Y2EzZmJhYzhmNDE2ZDg1N2ZjOCIsInN1YiI6IjY0ZDVlMDc2YjZjMjY0MTE1NWYwNjJjZiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.S7qsL6lDZvrxQbKKo6ekaGbZ6i5R1MhjX6tgMuC5LCY'
  },
  };
  let response;
